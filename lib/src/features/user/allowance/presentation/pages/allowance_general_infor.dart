                          ...
                          if (checkonclickdraft == false) ...[
                            ...
                            EmailMultiSelectDropDown(
                              onOptionSelected: (selectedValues) {
                                ...
                                formData['cc_email'] = concatenatedString;
                                print(formData);
                                print(
                                  "FORMDATA EMAIL${formData['cc_email']}",
                                );
                              },
                          ...
                          CustomSearchField(
                            ...
                            validator: (String? value) {
                              if (value != null && value.isNotEmpty) {
                                ...
                                List<String> suggestionTexts = state
                                    .empsallrole!
                                    .map((e) =>
                                        "${e.firstnameTh} ${e.lastnameTh}"
                                            .trim())
                                                          ...
                                                          Text('Start Date',
                                                              style: TextStyle(
                                                                  ...
                                                                  color: Colors
                                                                      .white)),
                                                          Text(
                                                              ' ${listExpense[index]['startDate'].split(":")[0]}',
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .white)),
                                                        ],
                                                          ...
                                                          Text('End Date',
                                                              style: TextStyle(
                                                                  ...
                                                                  color: Colors
                                                                      .white)),
                                                          Text(
                                                              '${listExpense[index]['endDate'].split(":")[0]}',
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .white)),
                                                        ],
                              ...
                              decoration: InputDecoration(
                                ...
                                focusedBorder: OutlineInputBorder(
                                  borderSide: const BorderSide(
                                      width: 2.0,
                                      color:
                                          Color.fromARGB(255, 252, 119, 119)),
                                  borderRadius: BorderRadius.circular(30),
                                ),
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(30),
                              ...
                              onPressed: () async {
                                ...
                                if (_keyForm.currentState!.validate()) {
                                  ...
                                  allowanceBloc.add(AddExpenseAllowanceEvent(
                                    idCompany: profileProvider
                                        .profileData.idEmployees!,
